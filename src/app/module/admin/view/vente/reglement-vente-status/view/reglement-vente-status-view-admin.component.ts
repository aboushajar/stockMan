...
@Component({
  selector: 'app-reglement-vente-status-view-admin',
  templateUrl: './reglement-vente-status-view-admin.component.html'
})
export class ReglementVenteStatusViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReglementVenteStatusAdminService){
