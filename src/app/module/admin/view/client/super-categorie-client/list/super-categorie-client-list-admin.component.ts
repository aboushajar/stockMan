...
@Component({
  selector: 'app-super-categorie-client-list-admin',
  templateUrl: './super-categorie-client-list-admin.component.html'
})
export class SuperCategorieClientListAdminComponent implements OnInit {

    protected fileName = 'SuperCategorieClient';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SuperCategorieClientDto>();
    ...
    public async edit(dto: SuperCategorieClientDto) {
    ...
    public async view(dto: SuperCategorieClientDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SuperCategorieClientDto) {
    ...
    public async duplicate(dto: SuperCategorieClientDto) {
    ...
    public exportPdf(dto: SuperCategorieClientDto): void {
...
// add
	...
	public initDuplicate(res: SuperCategorieClientDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<SuperCategorieClientDto> {
        return this.service.selections;
    }

    set selections(value: Array<SuperCategorieClientDto>) {
