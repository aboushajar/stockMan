...
export class InventaireCreateAdminComponent  implements OnInit {
   ...
   private _validInventaireDepot = true;
    ...
    public validateInventaireItemsSousMarque(){
    ...
    public validateInventaireItemsQuantiteAnticipe(){
    ...
    public validateInventaireItemsDecalage(){
    ...
    public validateInventaireItemsInventaire(){
