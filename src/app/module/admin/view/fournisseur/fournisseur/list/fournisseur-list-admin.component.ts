...
export class FournisseurListAdminComponent implements OnInit {
    ...
    protected fileName = 'Fournisseur';
    ...
    categorieFournisseurs: Array<CategorieFournisseurDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<FournisseurDto>();
    ...
    public async edit(dto: FournisseurDto) {
    ...
    public async view(dto: FournisseurDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: FournisseurDto) {
    ...
    public async duplicate(dto: FournisseurDto) {
    ...
    public exportPdf(dto: FournisseurDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'categorieFournisseur?.libelle', header: 'Categorie fournisseur'},
    ...
    public async loadCategorieFournisseur(){
        this.categorieFournisseurService.findAllOptimized().subscribe(categorieFournisseurs => this.categorieFournisseurs = categorieFournisseurs, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                'Categorie fournisseur': e.categorieFournisseur?.libelle ,
        ...
        this.criteriaData = [{
        //'Categorie fournisseur': this.criteria.categorieFournisseur?.libelle ? this.criteria.categorieFournisseur?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<FournisseurDto> {
        return this.service.selections;
    }

    set selections(value: Array<FournisseurDto>) {
