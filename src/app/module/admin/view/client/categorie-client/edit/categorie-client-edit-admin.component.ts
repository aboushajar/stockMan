...
@Component({
  selector: 'app-categorie-client-edit-admin',
  templateUrl: './categorie-client-edit-admin.component.html'
})
export class CategorieClientEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateSuperCategorieClient(superCategorieClient: string) {
        const isPermistted = await this.roleService.isPermitted('SuperCategorieClient', 'edit');
        if (isPermistted) {
