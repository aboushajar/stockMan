...
export class CategorieClientListAdminComponent implements OnInit {

    protected fileName = 'CategorieClient';
    ...
    superCategorieClients: Array<SuperCategorieClientDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieClientDto>();
    ...
    public async edit(dto: CategorieClientDto) {
    ...
    public async view(dto: CategorieClientDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieClientDto) {
    ...
    public async duplicate(dto: CategorieClientDto) {
    ...
    public exportPdf(dto: CategorieClientDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'superCategorieClient?.libelle', header: 'Super categorie client'},
        ];
    }


    public async loadSuperCategorieClient(){
        this.superCategorieClientService.findAllOptimized().subscribe(superCategorieClients => this.superCategorieClients = superCategorieClients, error => console.log(error))
    }


	public initDuplicate(res: CategorieClientDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Libelle': e.libelle ,
                 'Code': e.code ,
                'Super categorie client': e.superCategorieClient?.libelle ,
            }
        });
        ...
        //'Super categorie client': this.criteria.superCategorieClient?.libelle ? this.criteria.superCategorieClient?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<CategorieClientDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieClientDto>) {
