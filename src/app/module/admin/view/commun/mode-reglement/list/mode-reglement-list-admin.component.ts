...
export class ModeReglementListAdminComponent implements OnInit {

    protected fileName = 'ModeReglement';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ModeReglementDto>();
    ...
    public async edit(dto: ModeReglementDto) {
    ...
    public async view(dto: ModeReglementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ModeReglementDto) {
    ...
    public async duplicate(dto: ModeReglementDto) {
    ...
    public exportPdf(dto: ModeReglementDto): void {
...
// add
	...
	public initDuplicate(res: ModeReglementDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ModeReglementDto> {
        return this.service.selections;
    }

    set selections(value: Array<ModeReglementDto>) {
