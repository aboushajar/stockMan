...
export class DepotListAdminComponent implements OnInit {

    protected fileName = 'Depot';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DepotDto>();
    ...
    public async edit(dto: DepotDto) {
    ...
    public async view(dto: DepotDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DepotDto) {
    ...
    public async duplicate(dto: DepotDto) {
    ...
    public exportPdf(dto: DepotDto): void {
...
// add
	...
	public initDuplicate(res: DepotDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<DepotDto> {
        return this.service.selections;
    }

    set selections(value: Array<DepotDto>) {
