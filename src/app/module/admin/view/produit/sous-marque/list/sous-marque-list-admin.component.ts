...
@Component({
  selector: 'app-sous-marque-list-admin',
  templateUrl: './sous-marque-list-admin.component.html'
})
export class SousMarqueListAdminComponent implements OnInit {

    protected fileName = 'SousMarque';
    ...
    statutSousMarques: Array<StatutSousMarqueDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SousMarqueDto>();
    ...
    public async edit(dto: SousMarqueDto) {
    ...
    public async view(dto: SousMarqueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SousMarqueDto) {
    ...
    public async duplicate(dto: SousMarqueDto) {
    ...
    public exportPdf(dto: SousMarqueDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'statutSousMarque?.libelle', header: 'Statut sous marque'},
            {field: 'prixVente', header: 'Prix vente'},
            {field: 'prixAchat', header: 'Prix achat'},
        ];
    }
    ...
    public async loadStatutSousMarque(){
        this.statutSousMarqueService.findAllOptimized().subscribe(statutSousMarques => this.statutSousMarques = statutSousMarques, error => console.log(error))
    }


	public initDuplicate(res: SousMarqueDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Statut sous marque': e.statutSousMarque?.libelle ,
                 'Prix vente': e.prixVente ,
                 'Prix achat': e.prixAchat ,
                 'Remarque': e.remarque ,
            }
        });
        ...
        //'Statut sous marque': this.criteria.statutSousMarque?.libelle ? this.criteria.statutSousMarque?.libelle : environment.emptyForExport ,
            ...
            'Prix achat Min': this.criteria.prixAchatMin ? this.criteria.prixAchatMin : environment.emptyForExport ,
            'Prix achat Max': this.criteria.prixAchatMax ? this.criteria.prixAchatMax : environment.emptyForExport ,
    ...
    get selections(): Array<SousMarqueDto> {
        return this.service.selections;
    }

    set selections(value: Array<SousMarqueDto>) {
