...
@Component({
  selector: 'app-super-categorie-client-view-admin',
  templateUrl: './super-categorie-client-view-admin.component.html'
})
export class SuperCategorieClientViewAdminComponent implements OnInit {
    ...
    constructor(private service: SuperCategorieClientAdminService){
