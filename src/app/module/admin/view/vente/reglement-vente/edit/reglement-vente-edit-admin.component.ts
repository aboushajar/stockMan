...
@Component({
  selector: 'app-reglement-vente-edit-admin',
  templateUrl: './reglement-vente-edit-admin.component.html'
})
export class ReglementVenteEditAdminComponent implements OnInit {
