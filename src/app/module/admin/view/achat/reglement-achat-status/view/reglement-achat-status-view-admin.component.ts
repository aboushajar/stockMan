...
@Component({
  selector: 'app-reglement-achat-status-view-admin',
  templateUrl: './reglement-achat-status-view-admin.component.html'
})
export class ReglementAchatStatusViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReglementAchatStatusAdminService){
