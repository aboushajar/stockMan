...
@Component({
  selector: 'app-reglement-vente-status-list-admin',
  templateUrl: './reglement-vente-status-list-admin.component.html'
})
export class ReglementVenteStatusListAdminComponent implements OnInit {

    protected fileName = 'ReglementVenteStatus';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReglementVenteStatusDto>();
    ...
    public async edit(dto: ReglementVenteStatusDto) {
    ...
    public async view(dto: ReglementVenteStatusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReglementVenteStatusDto) {
    ...
    public async duplicate(dto: ReglementVenteStatusDto) {
    ...
    public exportPdf(dto: ReglementVenteStatusDto): void {
...
// add
	...
	public initDuplicate(res: ReglementVenteStatusDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ReglementVenteStatusDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReglementVenteStatusDto>) {
