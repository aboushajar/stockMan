...
export class InventaireListAdminComponent implements OnInit {

    protected fileName = 'Inventaire';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InventaireDto>();
    ...
    public async edit(dto: InventaireDto) {
    ...
    public async view(dto: InventaireDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InventaireDto) {
    ...
    public async duplicate(dto: InventaireDto) {
    ...
    public exportPdf(dto: InventaireDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'dateInventaite', header: 'Date inventaite'},
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                'Date inventaite': this.datePipe.transform(e.dateInventaite , 'dd/MM/yyyy hh:mm'),
        ...
        this.criteriaData = [{
            'Date inventaite Min': this.criteria.dateInventaiteFrom ? this.datePipe.transform(this.criteria.dateInventaiteFrom , this.dateFormat) : environment.emptyForExport ,
            'Date inventaite Max': this.criteria.dateInventaiteTo ? this.datePipe.transform(this.criteria.dateInventaiteTo , this.dateFormat) : environment.emptyForExport ,
    ...
    get selections(): Array<InventaireDto> {
        return this.service.selections;
    }

    set selections(value: Array<InventaireDto>) {
