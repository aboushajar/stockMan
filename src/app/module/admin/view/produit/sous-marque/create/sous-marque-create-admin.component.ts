...
@Component({
  selector: 'app-sous-marque-create-admin',
  templateUrl: './sous-marque-create-admin.component.html'
})
export class SousMarqueCreateAdminComponent  implements OnInit {
   ...
   private _validSousMarqueStatutSousMarque = true;
    ...
    const isPermistted = await this.roleService.isPermitted('StatutSousMarque', 'add');
    if(isPermistted) {
