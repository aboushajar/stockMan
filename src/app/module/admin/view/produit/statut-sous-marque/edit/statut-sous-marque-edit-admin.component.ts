...
@Component({
  selector: 'app-statut-sous-marque-edit-admin',
  templateUrl: './statut-sous-marque-edit-admin.component.html'
})
export class StatutSousMarqueEditAdminComponent implements OnInit {
