...
@Component({
  selector: 'app-statut-sous-marque-list-admin',
  templateUrl: './statut-sous-marque-list-admin.component.html'
})
export class StatutSousMarqueListAdminComponent implements OnInit {

    protected fileName = 'StatutSousMarque';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<StatutSousMarqueDto>();
    ...
    public async edit(dto: StatutSousMarqueDto) {
    ...
    public async view(dto: StatutSousMarqueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: StatutSousMarqueDto) {
    ...
    public async duplicate(dto: StatutSousMarqueDto) {
    ...
    public exportPdf(dto: StatutSousMarqueDto): void {
...
// add
	...
	public initDuplicate(res: StatutSousMarqueDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<StatutSousMarqueDto> {
        return this.service.selections;
    }

    set selections(value: Array<StatutSousMarqueDto>) {
