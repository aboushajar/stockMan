...
@Component({
  selector: 'app-reglement-achat-status-list-admin',
  templateUrl: './reglement-achat-status-list-admin.component.html'
})
export class ReglementAchatStatusListAdminComponent implements OnInit {

    protected fileName = 'ReglementAchatStatus';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReglementAchatStatusDto>();
    ...
    public async edit(dto: ReglementAchatStatusDto) {
    ...
    public async view(dto: ReglementAchatStatusDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReglementAchatStatusDto) {
    ...
    public async duplicate(dto: ReglementAchatStatusDto) {
    ...
    public exportPdf(dto: ReglementAchatStatusDto): void {
...
// add
	...
	public initDuplicate(res: ReglementAchatStatusDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ReglementAchatStatusDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReglementAchatStatusDto>) {
