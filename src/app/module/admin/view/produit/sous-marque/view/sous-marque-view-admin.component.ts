...
@Component({
  selector: 'app-sous-marque-view-admin',
  templateUrl: './sous-marque-view-admin.component.html'
})
export class SousMarqueViewAdminComponent implements OnInit {
    ...
    constructor(private service: SousMarqueAdminService, private marqueService: MarqueAdminService, private statutSousMarqueService: StatutSousMarqueAdminService){
