...
@Component({
  selector: 'app-point-vente-view-admin',
  templateUrl: './point-vente-view-admin.component.html'
})
export class PointVenteViewAdminComponent implements OnInit {
    ...
    depots = new DepotDto();
    depotss: Array<DepotDto> = [];

    constructor(private service: PointVenteAdminService, private depotService: DepotAdminService){
