...
export class EtatAchatListAdminComponent implements OnInit {

    protected fileName = 'EtatAchat';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatAchatDto>();
    ...
    public async edit(dto: EtatAchatDto) {
    ...
    public async view(dto: EtatAchatDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatAchatDto) {
    ...
    public async duplicate(dto: EtatAchatDto) {
    ...
    public exportPdf(dto: EtatAchatDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EtatAchatDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatAchatDto>) {
