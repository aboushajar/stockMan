...
export class MarqueListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MarqueDto>();
    ...
    public async edit(dto: MarqueDto) {
    ...
    public async view(dto: MarqueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MarqueDto) {
    ...
    public async duplicate(dto: MarqueDto) {
    ...
    public exportPdf(dto: MarqueDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<MarqueDto> {
        return this.service.selections;
    }

    set selections(value: Array<MarqueDto>) {
