...
export class CategorieProduitListAdminComponent implements OnInit {
    ...
    protected fileName = 'CategorieProduit';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieProduitDto>();
    ...
    public async edit(dto: CategorieProduitDto) {
    ...
    public async view(dto: CategorieProduitDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieProduitDto) {
    ...
    public async duplicate(dto: CategorieProduitDto) {
    ...
    public exportPdf(dto: CategorieProduitDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CategorieProduitDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieProduitDto>) {
