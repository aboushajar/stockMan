...
@Component({
  selector: 'app-categorie-fournisseur-list-admin',
  templateUrl: './categorie-fournisseur-list-admin.component.html'
})
export class CategorieFournisseurListAdminComponent implements OnInit {

    protected fileName = 'CategorieFournisseur';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategorieFournisseurDto>();
    ...
    public async edit(dto: CategorieFournisseurDto) {
    ...
    public async view(dto: CategorieFournisseurDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategorieFournisseurDto) {
    ...
    public async duplicate(dto: CategorieFournisseurDto) {
    ...
    public exportPdf(dto: CategorieFournisseurDto): void {
...
// add
	...
	public initDuplicate(res: CategorieFournisseurDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CategorieFournisseurDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategorieFournisseurDto>) {
