...
@Component({
  selector: 'app-reglement-achat-edit-admin',
  templateUrl: './reglement-achat-edit-admin.component.html'
})
export class ReglementAchatEditAdminComponent implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReglement = this.service.format(this.item.dateReglement);
    }
