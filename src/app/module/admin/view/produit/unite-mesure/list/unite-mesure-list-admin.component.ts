...
export class UniteMesureListAdminComponent implements OnInit {

    protected fileName = 'UniteMesure';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<UniteMesureDto>();
    ...
    public async edit(dto: UniteMesureDto) {
    ...
    public async view(dto: UniteMesureDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: UniteMesureDto) {
    ...
    public async duplicate(dto: UniteMesureDto) {
    ...
    public exportPdf(dto: UniteMesureDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<UniteMesureDto> {
        return this.service.selections;
    }

    set selections(value: Array<UniteMesureDto>) {
