...
@Component({
  selector: 'app-statut-sous-marque-view-admin',
  templateUrl: './statut-sous-marque-view-admin.component.html'
})
export class StatutSousMarqueViewAdminComponent implements OnInit {
    ...
    constructor(private service: StatutSousMarqueAdminService){
