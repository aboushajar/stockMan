...
export class EtatVenteListAdminComponent implements OnInit {

    protected fileName = 'EtatVente';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatVenteDto>();
    ...
    public async edit(dto: EtatVenteDto) {
    ...
    public async view(dto: EtatVenteDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatVenteDto) {
    ...
    public async duplicate(dto: EtatVenteDto) {
    ...
    public exportPdf(dto: EtatVenteDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EtatVenteDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatVenteDto>) {
