...
export class TransfertListAdminComponent implements OnInit {

    protected fileName = 'Transfert';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TransfertDto>();
    ...
    public async edit(dto: TransfertDto) {
    ...
    public async view(dto: TransfertDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TransfertDto) {
    ...
    public async duplicate(dto: TransfertDto) {
    ...
    public exportPdf(dto: TransfertDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'depotOrigin?.libelle', header: 'Depot origin'},
            {field: 'depotDestination?.libelle', header: 'Depot destination'},
        ];
    }


    public async loadDepotOrigin(){
        this.depotService.findAllOptimized().subscribe(depotOrigins => this.depotOrigins = depotOrigins, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Depot origin': e.depotOrigin?.libelle ,
        ...
        //'Depot origin': this.criteria.depotOrigin?.libelle ? this.criteria.depotOrigin?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<TransfertDto> {
        return this.service.selections;
    }

    set selections(value: Array<TransfertDto>) {
