...
@Component({
  selector: 'app-reglement-achat-status-create-admin',
  templateUrl: './reglement-achat-status-create-admin.component.html'
})
export class ReglementAchatStatusCreateAdminComponent  implements OnInit {
