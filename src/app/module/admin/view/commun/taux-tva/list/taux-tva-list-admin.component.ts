...
export class TauxTvaListAdminComponent implements OnInit {

    protected fileName = 'TauxTva';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TauxTvaDto>();
    ...
    public async edit(dto: TauxTvaDto) {
    ...
    public async view(dto: TauxTvaDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TauxTvaDto) {
    ...
    public async duplicate(dto: TauxTvaDto) {
    ...
    public exportPdf(dto: TauxTvaDto): void {
...
// add
	...
	public initDuplicate(res: TauxTvaDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TauxTvaDto> {
        return this.service.selections;
    }

    set selections(value: Array<TauxTvaDto>) {
